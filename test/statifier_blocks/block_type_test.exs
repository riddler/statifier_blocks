defmodule StatifierBlocks.BlockTypeTest do
  ...
  describe "behaviour_info/1" do
    ...
    test "callbacks/1 is exactly the twelve declared callbacks" do
    ...
    test "optional_callbacks/1 is exactly the seven optional callbacks" do
