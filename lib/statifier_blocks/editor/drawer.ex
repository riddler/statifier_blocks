if Code.ensure_loaded?(Phoenix.LiveView) do
  defmodule StatifierBlocks.Editor.Drawer do
    ...
    **The server owns the movement, and nothing here is a JavaScript hook.**
    ...
    # here decides what the click does with the key - that answer, and the
    # focusing it drives, belongs to the editor and the config form, not to
    # this listing.
    #
    ...
    defp source_span(assigns) do
      ...
      <button
        ...
        phx-value-config-key={@span.config_key}
        phx-target={@target}
